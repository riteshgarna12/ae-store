    ...
    <>
      ...
      >
        ...
        <div style={{
          ...
          <h2 style={{ fontFamily: 'Outfit', fontWeight: 800, fontSize: '1.3rem', margin: 0, display: 'flex', alignItems: 'center', gap: '8px', color: 'var(--text-primary)' }}>
        ...
        {/* Tab Buttons */}
        <div style={{
          display: 'flex', borderBottom: '1px solid var(--border-secondary)', background: 'rgba(8,8,10,0.3)', padding: '6px'
        }}>
          {tabs.map(tab => (
            <button
              key={tab.id}
              ...
              style={{
                ...
                color: activeTab === tab.id ? 'var(--text-primary)' : 'var(--text-muted)', fontWeight: 600, fontSize: '0.85rem',
        ...
        {/* Content Panel */}
        <div style={{ flex: 1, overflowY: 'auto', padding: '24px', fontFamily: 'Inter', fontSize: '0.88rem', lineHeight: 1.7, color: 'var(--text-secondary)' }}>
          <AnimatePresence mode="wait">
            {activeTab === 'terms' && (
              ...
              >
                <h3 style={{ fontFamily: 'Outfit', color: 'var(--text-primary)', fontSize: '1.05rem', fontWeight: 700, marginBottom: '14px' }}>Terms & Licensing Agreement</h3>
                ...
                <h4 style={{ color: 'var(--text-primary)', fontSize: '0.95rem', fontWeight: 600, marginTop: '20px', marginBottom: '8px' }}>1. Grant of License</h4>
                ...
                <h4 style={{ color: 'var(--text-primary)', fontSize: '0.95rem', fontWeight: 600, marginTop: '20px', marginBottom: '8px' }}>2. Permitted Uses</h4>
                ...
                <h4 style={{ color: 'var(--text-primary)', fontSize: '0.95rem', fontWeight: 600, marginTop: '20px', marginBottom: '8px' }}>3. Prohibited Uses</h4>
                <ul style={{ paddingLeft: '20px', marginBottom: '14px', color: '#aaa' }}>
                ...
                <h4 style={{ color: 'var(--text-primary)', fontSize: '0.95rem', fontWeight: 600, marginTop: '20px', marginBottom: '8px' }}>4. Intellectual Property</h4>
                <p style={{ marginBottom: '14px', color: '#aaa' }}>
            ...
            {activeTab === 'privacy' && (
              <motion.div
                ...
                transition={{ duration: 0.2 }}
              >
                <h3 style={{ fontFamily: 'Outfit', color: 'var(--text-primary)', fontSize: '1.05rem', fontWeight: 700, marginBottom: '14px' }}>Privacy Policy</h3>
                ...
                <h4 style={{ color: 'var(--text-primary)', fontSize: '0.95rem', fontWeight: 600, marginTop: '20px', marginBottom: '8px' }}>1. Information We Collect</h4>
                <p style={{ marginBottom: '14px', color: '#aaa' }}>
                ...
                <h4 style={{ color: 'var(--text-primary)', fontSize: '0.95rem', fontWeight: 600, marginTop: '20px', marginBottom: '8px' }}>2. How We Use Your Data</h4>
                <p style={{ marginBottom: '14px', color: '#aaa' }}>
                ...
                <h4 style={{ color: 'var(--text-primary)', fontSize: '0.95rem', fontWeight: 600, marginTop: '20px', marginBottom: '8px' }}>3. Secure Payments</h4>
                <p style={{ marginBottom: '14px', color: '#aaa' }}>
                ...
                <h4 style={{ color: 'var(--text-primary)', fontSize: '0.95rem', fontWeight: 600, marginTop: '20px', marginBottom: '8px' }}>4. Data Security</h4>
                <p style={{ marginBottom: '14px', color: '#aaa' }}>
            ...
            {activeTab === 'refund' && (
              <motion.div
                ...
                transition={{ duration: 0.2 }}
              >
                <h3 style={{ fontFamily: 'Outfit', color: 'var(--text-primary)', fontSize: '1.05rem', fontWeight: 700, marginBottom: '14px' }}>Refund & Delivery Policy</h3>
                ...
                <h4 style={{ color: 'var(--text-primary)', fontSize: '0.95rem', fontWeight: 600, marginTop: '20px', marginBottom: '8px' }}>1. Digital Product Nature</h4>
                <p style={{ marginBottom: '14px', color: '#aaa' }}>
                ...
                <h4 style={{ color: 'var(--text-primary)', fontSize: '0.95rem', fontWeight: 600, marginTop: '20px', marginBottom: '8px' }}>2. Technical Defect Policy</h4>
                <p style={{ marginBottom: '14px', color: '#aaa' }}>
                ...
                <h4 style={{ color: 'var(--text-primary)', fontSize: '0.95rem', fontWeight: 600, marginTop: '20px', marginBottom: '8px' }}>3. How to Request Help</h4>
                <p style={{ marginBottom: '14px', color: '#aaa' }}>
                ...
                <h4 style={{ color: 'var(--text-primary)', fontSize: '0.95rem', fontWeight: 600, marginTop: '20px', marginBottom: '8px' }}>4. Delivery Time</h4>
                <p style={{ marginBottom: '14px', color: '#aaa' }}>
